...
- Delegate to SoftwareEngineer instances assigned to your segment
...
|--------------|---------------------|-------------------|
| Small (<5K LOC) | Low | Segment Lead + 1 SoftwareEngineer |
| Medium (5-30K) | Medium | Segment Lead + 2 SoftwareEngineer |
| Large (>30K) | High | Segment Lead + 3 SoftwareEngineer |

**Segment SoftwareEngineer Bootstrap Prompt Template:**

```
You are SoftwareEngineer[N], a Software Engineer on [Segment Name] for [Sprint Name].
